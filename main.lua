...
function init()
  ...
  character_classes = {
    ...
    ['flagellant'] = {'psyker', 'enchanter', 'cultist'},
    ['arcanist'] = {'sorcerer'},
	...
	['psylander'] = {'psyker', 'warrior', 'cultist'},
	['locust'] = {'swarmer', 'nuker'},
	['boomerang'] = {'ranger', 'sorcerer'},
	['rocketeer'] = {'ranger', 'nuker'},
	['initiate'] = {'cultist'},
	['necromancer'] = {'cultist', 'swarmer'},
	['acolyte'] = {'conjurer', 'cultist'},
	['shaman'] = {'mage', 'cultist'}
  }
  ...
  character_class_strings = {
    ...
    ['flagellant'] = '[fg]Psyker, [blue]Enchanter', '[dBlue]Cultist',
    ...
    ['psylander'] = '[fg]Psyker, [yellow]Warrior, [dblue]Cultist',
    ['locust'] = '[orange]Swarmer, [red]Nuker',
	['boomerang'] = '[green]Ranger, [blue2]Sorcerer',
	['rocketeer'] = '[green]Ranger, Nuker',
	['initiate'] = '[dblue]Cultist',
	['necromancer'] = '[dblue]Cultist, [orange]Swarmer',
	['acolyte'] = '[orange]Builder, [dblue]Cultist',
	['shaman'] = '[blue]Mage, [dblue]Cultist'
  }
  ...
  character_descriptions = {
    ...
    ['psykeeper'] = function(lvl) return '[fg]creates [yellow]3[fg] healing orbs every time the psykeeper takes [yellow]20%[fg] of its max HP in damage' end,
    ...
    ['cryomancer'] = function(lvl) return '[fg]nearby enemies take [yellow]' .. get_character_stat('cryomancer', lvl, 'dmg') .. '[fg] damage per second and get slowed depending on unit level' end,
    ...
    ['bane'] = function(lvl) return '[fg]curses [yellow]8[fg] nearby enemies for [yellow]6[fg] seconds, they will create small void rifts on death' end,
    ...
    ['flagellant'] = function(lvl) return '[fg]deals [yellow]' .. 2*get_character_stat('flagellant', lvl, 'dmg') .. '[fg] damage to self and grants [yellow]+5%[fg] damage to all allies per cast' end,
    ...
    ['merchant'] = function(lvl) return '[fg]gain [yellow]+1[fg] interest for every [yellow]10[fg] gold, up to a max of [yellow]+8[fg] from the merchant' end,
    ...
    ['psybanker'] = function(lvl) return '[fg]gain [yellow]+X/15[fg] interest, where X is enemies killed this round with an interest cap of 8' end,
	...
	['boomerang'] = function(lvl) return '[fg]throws a magic boomerang that deals [yellow]'..get_character_stat('boomerang', lvl, 'dmg')..'[fg] damage and ricochets' end,
	['rocketeer'] = function(lvl) return '[fg]fires a rocket that deals [yellow]'..get_character_stat('rocketeer', lvl, 'dmg')..'[fg] AoE damage' end,
	['initiate'] = function(lvl) return '[fg]shoots a bolt that deals [yellow]'..3*get_character_stat('initiate', lvl, 'dmg')..'[fg] dmg to an enemy and [yellow]'..0.5*get_character_stat('initiate', lvl, 'dmg')..'[fg] dmg to a random ally' end,
    ['necromancer'] = function(lvl) return '[fg]deals [yellow]'..get_character_stat('necromancer', lvl, 'dmg')..'[fg] damage to a random ally and spawns [yellow]1[fg] large critter' end,
	['acolyte'] = function(lvl) return '[fg]deals [yellow]'..get_character_stat('acolyte', lvl, 'dmg')..'[fg] damage to itself, spawns an altar that deals DoT to nearby enemies' end,
	['shaman'] = function(lvl) return '[fg]summons lightning that deals [yellow]'..get_character_stat('shaman', lvl, 'dmg')..'[fg] damage to all nearby enemies' end,
  }
  ...
  character_effect_names = {
	...
	['sylph'] = '[yellow]Impact Funnel',
	['blood_elf'] = '[green]Lifesteal',
	['psylander'] = '[fg]There Can Only Be One',
	['locust'] = '[orange]Infinite Swarm',
	['boomerang'] = '[green]Recursive Awe',
	['rocketeer'] = '[red]Critical Burst',
	['initiate'] = '[dblue]Ritual',
	['necromancer'] = '[dblue]Soul Harvest',
	['acolyte'] = '[dblue]Sacrifical Dagger',
	['shaman'] = '[dblue]Spirit Intermediation'
  }
  ...
  character_effect_names_gray = {
	...
	['sylph'] = '[light_bg]Impact Funnel',
	['blood_elf'] = '[light_bg]Lifesteal',
	['psylander'] = '[light_bg]There Can Be Only One',
	['locust'] = '[light_bg]Infinite Swarm',
	['boomerang'] = '[light_bg]Recursive Awe',
	['rocketeer'] = '[light_bg]Critical Burst',
	['initiate'] = '[light_bg]Ritual',
	['necromancer'] = '[light_bg]Soul Harvest',
	['acolyte'] = '[light_bg]Sacrifical Dagger',
	['shaman'] = '[light_bg]Spirit Intermediation'
  }

  character_effect_descriptions = {
    ['vagrant'] = function() return '[yellow]+15%[fg] attack speed and damage per active class' end,
    ['swordsman'] = function() return "[fg]the swordsman's damage is [yellow]tripled" end,
    ...
    ['bomber'] = function() return '[yellow]+150%[fg] bomb area and damage' end,
    ['stormweaver'] = function() return "[fg]chain lightning's trigger area of effect and number of units hit is [yellow]doubled" end,
    ['sage'] = function() return '[fg]when the projectile expires deal [yellow]' .. 9*get_character_stat('sage', 3, 'dmg') .. '[fg] damage to all enemies under its influence' end,
    ['squire'] = function() return '[yellow]squire instead gives +30%[fg] damage, attack speed, movement speed and defense to all allies' end,
    ...
    ['sentry'] = function() return '[fg]sentry turret projectiles ricochet [yellow]5[fg] times' end,
    ...
    ['psykeeper'] = function() return '[fg]deal [yellow]triple[fg] the contact damage psykeeper does to all enemies' end,
    ['engineer'] = function() return '[fg]drops [yellow]2[fg] additional turrets and grants all turrets [yellow]+100%[fg] damage and attack speed' end,
    ...
    ['cryomancer'] = function() return '[fg]enemies take 4x damage from the cryomancer' end,
    ...
    ['highlander'] = function() return '[fg]quickly repeats the attack [yellow]5[fg] times' end,
    ['fairy'] = function() return '[fg]creates [yellow]2[fg] healing orbs and grants [yellow]2[fg] units [yellow]+100%[fg] attack speed' end,
    ['priest'] = function() return '[fg]picks [yellow]4[fg] units at random and grants them a buff that prevents death once' end,
    ['infestor'] = function() return '[fg][yellow]triples[fg] the number of critters released and curse 2 more units' end,
    ['flagellant'] = function() return '[yellow]4X[fg] flagellant max HP and grants [yellow]+15%[fg] damage to all allies per cast instead' end,
    ...
    ['artificer'] = function() return '[fg]automatons shoot and move 100% faster and release [yellow]12[fg] projectiles on death' end,
    ['witch'] = function() return '[fg]the area releases projectiles, each dealing [yellow]' .. get_character_stat('witch', 3, 'dmg') .. '[fg] damage and chaining twice' end,
    ['silencer'] = function() return '[fg]the curse stuns enemies, deals [yellow]' .. get_character_stat('silencer', 3, 'dmg') .. '[fg] damage and curses [yellow]3[fg] more enemies' end,
    ['vulcanist'] = function() return '[fg]the number and speed of explosions is [yellow]tripled[fg]' end,
    ...
    ['miner'] = function() return '[fg]release [yellow]8[fg] homing projectiles instead and they pierce thrice' end,
	...
	['sylph'] = function() return '[fg]when affected enemies hit walls they create an area based on the knockback force' end,
	...
	['boomerang'] = function() return "[fg]boomerangs automatically multicast [yellow]2[fg] times" end,
	['rocketeer'] = function() return "[yellow]+100%[fg] area size" end,
	['initiate'] = function() return "[fg]the initiate gains [yellow]+1%[fg] damage every attack" end,
	['necromancer'] = function() return "[fg]spawns [yellow]1[fg] small critter when a unit takes damage. [yellow]1[fg] second cooldown per unit" end,
	['acolyte'] = function() return '[fg]enemies killed by the altar fire off a dagger' end,
	['shaman'] = function() return '[fg]gains [yellow]+5%[fg] to every stat whenever an allied unit dies' end
  }
  ...
  character_effect_descriptions_gray = {
    ...
    ['bomber'] = function() return '[light_bg]+150% bomb area and damage' end,
    ['stormweaver'] = function() return "[light_bg]chain lightning's trigger area of effect and number of units hit is doubled" end,
    ['sage'] = function() return '[light_bg]when the projectile expires deal ' .. 9*get_character_stat('sage', 3, 'dmg') .. ' damage to all enemies under its influence' end,
    ['squire'] = function() return '[light_bg]squire instead gives +30% damage, attack speed, movement speed and defense to all allies' end,
    ...
    ['sentry'] = function() return '[light_bg]sentry turret projectiles ricochet 5 times' end,
    ...
    ['psykeeper'] = function() return '[light_bg]deal triple the contact damage psykeeper does to all enemies' end,
    ['engineer'] = function() return '[light_bg]drops 2 additional turrets and grants all turrets +100% damage and attack speed' end,
    ...
    ['cryomancer'] = function() return '[light_bg]enemies take 4x damage from the cryomancer' end,
    ...
    ['highlander'] = function() return '[light_bg]quickly repeats the attack 5 times' end,
    ['fairy'] = function() return '[light_bg]creates 2 healing orbs and grants 2 units +100% attack speed' end,
    ['priest'] = function() return '[light_bg]picks 4 units at random and grants them a buff that prevents death once' end,
    ['infestor'] = function() return '[light_bg]triples the number of critters released and curse 2 more units' end,
    ['flagellant'] = function() return '[light_bg]5X flagellant max HP and grants +12% damage to all allies per cast instead' end,
    ...
    ['artificer'] = function() return '[light_bg]automatons shoot and move 100% faster and release 12 projectiles on death' end,
    ['witch'] = function() return '[light_bg]the area periodically releases projectiles, each dealing ' .. get_character_stat('witch', 3, 'dmg') .. ' damage and chaining twice' end,
    ['silencer'] = function() return '[light_bg]the curse slows enemies by 75%, deals ' .. get_character_stat('silencer', 3, 'dmg') .. ' damage and curses 3 more enemies' end,
    ['vulcanist'] = function() return '[light_bg]the number and speed of explosions is tripled' end,
    ...
    ['miner'] = function() return '[light_bg]release 8 homing projectiles instead and they pierce thrice' end,
    ...
    ['sniper'] = function() return '[light_bg]bullets release an AoE that deal ' .. 0.25*get_character_stat('sniper', 3, 'dmg') .. ' damage upon crit' end,
	['brawler'] = function() return '[light_bg]gives itself +15% defense per active class' end,
	['psybanker'] = function() return '[light_bg]increase the defense of allied mercenaries by +25% for every mercenary' end,
	...
	['sylph'] = function() return '[light_bg]when affected enemies hit walls they create an area based on the knockback force' end,
	...
	['boomerang'] = function() return "[light_bg]boomerangs automatically multicast 2 times" end,
	['rocketeer'] = function() return "[light_bg]+100% area size" end,
	['initiate'] = function() return "[light_bg]the initiate gains +1% damage every attack" end,
	['necromancer'] = function() return "[light_bg]spawns 1 small critter when a unit takes damage. 1 second cooldown per unit" end,
	['acolyte'] = function() return '[light_bg]enemies killed by the altar fire off a dagger' end,
	['shaman'] = function() return '[light_bg]gains +5% to every stat whenever an allied unit dies' end
  }
  ...
  character_stats = {
    ...
    ['boomerang'] = function(lvl) return get_character_stat_string('boomerang', lvl) end,
    ['rocketeer'] = function(lvl) return get_character_stat_string('rocketeer', lvl) end,
    ['initiate'] = function(lvl) return get_character_stat_string('initiate', lvl) end,
    ['necromancer'] = function(lvl) return get_character_stat_string('necromancer', lvl) end,
    ['acolyte'] = function(lvl) return get_character_stat_string('acolyte', lvl) end,
    ['shaman'] = function(lvl) return get_character_stat_string('shaman', lvl) end,
  }

  class_stat_multipliers = {
    ['ranger'] = {hp = 0.8, dmg = 1.8, aspd = 1.2, area_dmg = 1, area_size = 1, def = 0.8, mvspd = 1.2},
    ...
    ['rogue'] = {hp = 0.8, dmg = 1.0, aspd = 1.4, area_dmg = 0.6, area_size = 0.6, def = 0.8, mvspd = 1.4},
    ...
    ['conjurer'] = {hp = 1, dmg = 1.3, aspd = 1, area_dmg = 1.25, area_size = 1.25, def = 1, mvspd = 1},
    ...
    ['swarmer'] = {hp = 1.2, dmg = 1, aspd = 1.35, area_dmg = 1, area_size = 1, def = 0.75, mvspd = 0.85},
    ['voider'] = {hp = 0.75, dmg = 1.3, aspd = 1, area_dmg = 0.8, area_size = 0.75, def = 0.6, mvspd = 0.8},
    ['sorcerer'] = {hp = 1, dmg = 1, aspd = 1.5, area_dmg = 1.2, area_size = 1, def = 1, mvspd = 1},
    ...
    ['cultist'] = {hp = 1.1, dmg = 1.4, aspd = 1, area_dmg = 1, area_size = 1, def = 1, mvspd = 1},
  ...
  class_descriptions = {
    ...
    ['mage'] = function(lvl) return '[' .. ylb1(lvl) .. ']3[light_bg]/[' .. ylb2(lvl) .. ']6 [fg]- [' .. ylb1(lvl) .. ']-20[light_bg]/[' .. ylb2(lvl) .. ']-40 [fg]enemy defense' end,
    ...
    ['healer'] = function(lvl) return '[' .. ylb1(lvl) .. ']2[light_bg]/[' .. ylb2(lvl) .. ']4 [fg]- [' .. ylb1(lvl) .. ']+20%[light_bg]/[' .. ylb2(lvl) .. ']+40% [fg] chance to create [yellow]+1[fg] healing orb on healing orb creation' end,
    ...
    ['voider'] = function(lvl) return '[' .. ylb1(lvl) .. ']2[light_bg]/[' .. ylb2(lvl) .. ']4 [fg]- [' .. ylb1(lvl) .. ']+25%[light_bg]/[' .. ylb2(lvl) .. ']+50% [fg]damage over time to allied voiders' end,
    ...
    ['explorer'] = function(lvl) return '[yellow]+15%[fg] attack speed and damage per active class to allied explorers' end,
     ['cultist'] = function(lvl) return '[' .. ylb1(lvl) .. ']2[light_bg]/[' .. ylb2(lvl) .. ']4[light_bg]/[' .. ylb3(lvl) .. ']6 [fg]- ['..ylb1(lvl)..']+5%[light_bg]/['..ylb2(lvl)..']+10%[light_bg]/['..ylb3(lvl)..']+15%[fg] to all cultist stats per allied unit killed' end,
  }

  tier_to_characters = {
    [1] = {'vagrant', 'swordsman', 'magician', 'archer', 'scout', 'cleric', 'arcanist', 'sentry', 'merchant','adventurer','brawler','initiate'},
    [2] = {'wizard', 'bomber', 'sage', 'squire', 'chronomancer', 'barbarian', 'cryomancer', 'host', 'beastmaster', 'jester', 'carver', 'psychic', 'witch', 'silencer', 'outlaw', 'miner','sylph','launcher','boomerang','rocketeer','necromancer','acolyte'},
    [3] = {'elementor', 'stormweaver', 'psykino', 'spellblade', 'psykeeper', 'engineer', 'plague_doctor', 'juggernaut', 'cannoneer', 'pyromancer', 'assassin', 'bane', 'barrager', 'infestor', 'flagellant', 'artificer', 'usurer','sniper','mortar','blood_elf','locust','shaman'},
    [4] = {'priest', 'highlander', 'fairy', 'blade', 'vulcanist', 'gambler', 'warden', 'corruptor', 'thief', 'dual_gunner','psybanker','psylander'},
  }
    ...
    for _, unit in ipairs(units) do
      for _, unit_class in ipairs(character_classes[unit.character]) do
        ...
        if unit_class == 'explorer' then explorers = explorers + 1 end
         if unit_class == 'cultist' then cultists = cultists + 1 end
      end
    end
    return {ranger = rangers, warrior = warriors, healer = healers, mage = mages, nuker = nukers, conjurer = conjurers, rogue = rogues,
      enchanter = enchanters, psyker = psykers, curser = cursers, forcer = forcers, swarmer = swarmers, voider = voiders, sorcerer = sorcerers, mercenary = mercenaries, explorer = explorers, cultist = cultists}
  end
  ...
  get_class_levels = function(units)
    ...
    return {
      ...
      explorer = units_to_class_level(units_per_class.explorer, 'explorer'),
       cultist = units_to_class_level(units_per_class.cultist, 'cultist'),
    }
  end
  ...
  class_set_numbers = {
    ...
    ['cultist'] = function(units) return 2, 4, 6, get_number_of_units_per_class(units).cultist end,
  }
  ...
  passive_descriptions = {
    ['centipede'] = '[yellow]+15/25/35%[fg] movement speed',
    ['ouroboros_technique_r'] = '[fg]rotating around yourself to the right releases [yellow]5/6/7[fg] projectiles per second',
    ['ouroboros_technique_l'] = '[fg]rotating around yourself to the left grants [yellow]+50/75/100%[fg] defense to all units',
    ['amplify'] = '[yellow]+20/40/60%[fg] AoE damage',
    ['resonance'] = '[fg]all AoE attacks deal [yellow]+3/6/10%[fg] damage per unit hit',
    ['ballista'] = '[yellow]+25/40/55%[fg] projectile damage',
    ['call_of_the_void'] = '[yellow]+50/100/150%[fg] DoT damage',
    ['crucio'] = '[fg]taking damage also shares that across all enemies at [yellow]20/30/40%[fg] its value',
    ['speed_3'] = '[fg]position [yellow]3[fg] has [yellow]+60%[fg] attack speed',
    ['damage_4'] = '[fg]position [yellow]4[fg] has [yellow]+60%[fg] damage',
    ['shoot_5'] = '[fg]position [yellow]5[fg] shoots [yellow]5[fg] projectiles per second',
    ['death_6'] = '[fg]position [yellow]6[fg] takes [yellow]10%[fg] of its health as damage every [yellow]3[fg] seconds',
    ['lasting_7'] = '[fg]position [yellow]7[fg] will stay alive for [yellow]20[fg] seconds after dying',
    ['defensive_stance'] = '[fg]first and last positions have [yellow]+20/40/60%[fg] defense',
    ['offensive_stance'] = '[fg]first and last positions have [yellow]+20/40/60%[fg] damage',
    ...
    ['last_stand'] = '[fg]the last unit alive is fully healed and receives a [yellow]+25%[fg] bonus to all stats',
    ['seeping'] = '[fg]enemies taking DoT damage have [yellow]-20/35/50%[fg] defense',
    ['deceleration'] = '[fg]enemies taking DoT damage have [yellow]-20/35/50%[fg] movement speed',
    ['annihilation'] = '[fg]when a voider dies deal its DoT damage to all enemies for [yellow]10[fg] seconds',
    ['malediction'] = '[yellow]+1/3/5[fg] max curse targets to all allied cursers',
    ['hextouch'] = '[fg]enemies take [yellow]10/20/30%[fg] of their health as damage per second for [yellow]2[fg] seconds when cursed',
    ['whispers_of_doom'] = '[fg]curses apply doom, deal [yellow]20/35/50%[fg] of enemy health as damage every [yellow]4/3/2[fg] doom instances',
    ...
    ['baneling_burst'] = '[fg]critters die immediately on contact but also deal [yellow]2X/3X/4X%[fg] of the enemy health as AoE damage, X being critter health',
    ['blunt_arrow'] = '[fg]ranger arrows have [yellow]+15/30/45%[fg] chance to knockback',
    ['explosive_arrow'] = '[fg]ranger arrows have [yellow]+10/20/30%[fg] chance to deal [yellow]10/20/30%[fg] AoE damage',
    ['divine_machine_arrow'] = '[fg]ranger arrows have a [yellow]15/25/35%[fg] chance to seek and pierce [yellow]1/2/3[fg] times',
    ['chronomancy'] = '[fg]mages cast their spells [yellow]25/35/45%[fg] faster',
    ['awakening'] = '[yellow]+50/75/100%[fg] attack speed and damage to [yellow]1[fg] mage every round for that round',
    ['divine_punishment'] = '[fg]deal [yellow]6X%[fg] of enemy health as damage to all enemies, X being how many mages you have',
    ['assassination'] = '[fg]crits from rogues deal [yellow]8/10/12x[fg] damage but normal attacks deal [yellow]two-thirds[fg] damage',
    ['flying_daggers'] = '[fg]all projectiles thrown by rogues chain [yellow]+1/2/3[fg] times',
    ...
    ['unleash'] = '[fg]all units gain [yellow]+1%[fg] area size and damage every second',
    ['reinforce'] = '[yellow]+8/16/24%[fg] global damage, defense and aspd if you have one or more enchanters',
    ['payback'] = '[yellow]+5/10/15%[fg] damage to all allies whenever an enchanter is hit',
    ['enchanted'] = '[yellow]+33/66/99%[fg] attack speed to a random unit if you have two or more enchanters',
    ['freezing_field'] = '[fg]creates an area that slows enemies by [yellow]75%[fg] for [yellow]4[fg] seconds on sorcerer spell repeat',
    ['burning_field'] = '[fg]creates an area that deals [yellow]90[fg] dps for [yellow]4[fg] seconds on sorcerer spell repeat',
    ['gravity_field'] = '[fg]creates an area that pulls enemies for [yellow]3[fg] and releases them at high speeds on sorcerer spell repeat',
    ['magnetism'] = '[fg]gold coins and healing orbs are attracted to the snake from a longer range',
    ['insurance'] = "[fg]heroes have [yellow]6[fg] times the chance of mercenary's bonus to drop [yellow]4[fg] gold on death",
    ['dividends'] = '[fg]mercenaries deal [yellow]+X%[fg] damage, where X is how much gold you have with a max of 1000%',
    ['berserking'] = '[fg]all warriors have up to [yellow]200/300/400%[fg] attack speed based on missing HP',
    ...
    ['blessing'] = '[yellow]+15/25/35%[fg] healing effectiveness',
    ['haste'] = '[yellow]+50%[fg] movement speed that decays over [yellow]4[fg] seconds on healing orb pick up',
    ['divine_barrage'] = '[yellow]30/60/90%[fg] chance to release a ricocheting barrage on healing orb pick up',
    ['orbitism'] = '[yellow]+33/66/99%[fg] psyker orb movement speed',
    ['psyker_orbs'] = '[yellow]+1/3/5[fg] total psyker orbs',
    ['psychosense'] = '[yellow]+33/66/99%[fg] orb range',
    ['psychosink'] = '[fg]psyker orbs deal [yellow]+50/100/150%[fg] damage',
    ['rearm'] = '[fg]constructs repeat their attacks once',
    ['taunt'] = '[yellow]15/30/45%[fg] chance for constructs to taunt nearby enemies on attack',
    ['construct_instability'] = '[fg]constructs explode when disappearing, dealing [yellow]200/300/400%[fg] damage',
    ['intimidation'] = '[fg]enemies spawn with [yellow]-10/20/30%[fg] max HP',
    ['vulnerability'] = '[fg]enemies take [yellow]+10/20/30%[fg] damage',
    ['temporal_chains'] = '[fg]enemies are [yellow]15/25/35%[fg] slower',
    ...
    ['critical_strike'] = '[yellow]8/16/24%[fg] chance for attacks to critically strike, dealing [yellow]2x[fg] damage',
    ['noxious_strike'] = '[yellow]8/16/24%[fg] chance for attacks to poison, dealing [yellow]25%[fg] dps for [yellow]4[fg] seconds',
    ['infesting_strike'] = '[yellow]8/16/24%[fg] chance for attacks to spawn [yellow]2[fg] critters on kill',
    ['kinetic_strike'] = '[yellow]20/40/60%[fg] chance for attacks to push enemies away with high force',
    ['burning_strike'] = 'Attacks burn, dealing [yellow]20%[fg] dps for [yellow]2[fg] seconds',
    ['lucky_strike'] = '[yellow]10%[fg] chance for attacks to cause enemies to drop gold on death',
    ...
    ['culling_strike'] = '[fg]instantly kill elites below [yellow]20/35/50%[fg] max HP',
    ['lightning_strike'] = '[yellow]5/10/15%[fg] chance for projectiles to create chain lightning, dealing [yellow]33/41/50%[fg] damage to each unit',
    ['psycholeak'] = '[fg]position [yellow]1[fg] generates [yellow]1[fg] psyker orb every [yellow]8[fg] seconds',
	...
	['ritual'] = 'all cultists gain [yellow]+1%[fg] damage for each attack',
	['sacrifice'] = 'whenever an unit dies, all cultists regain [yellow]+25/+50/+75%[fg] of their health'
  }
  ...
  passive_descriptions_level = {
    ['centipede'] = function(lvl) return ts(lvl, '+15%', '25%', '35%') .. ' movement speed' end,
    ['ouroboros_technique_r'] = function(lvl) return '[fg]rotating around yourself to the right releases ' .. ts(lvl, '5', '6', '7') .. ' projectiles per second' end,
    ['ouroboros_technique_l'] = function(lvl) return '[fg]rotating around yourself to the left grants ' .. ts(lvl, '+50%', '75%', '100%') .. ' defense to all units' end,
    ['amplify'] = function(lvl) return ts(lvl, '+20%', '40%', '60%') .. ' AoE damage' end,
    ['resonance'] = function(lvl) return '[fg]all AoE attacks deal ' .. ts(lvl, '+3%', '6%', '10%') .. ' damage per unit hit' end,
    ['ballista'] = function(lvl) return ts(lvl, '+25%', '40%', '55%') .. ' projectile damage' end,
    ['call_of_the_void'] = function(lvl) return ts(lvl, '+50%', '100%', '150%') .. ' DoT damage' end,
    ['crucio'] = function(lvl) return '[fg]taking damage also shares that across all enemies at ' .. ts(lvl, '20%', '30%', '40%') .. ' its value' end,
    ['speed_3'] = function(lvl) return '[fg]position [yellow]3[fg] has [yellow]+60%[fg] attack speed' end,
    ['damage_4'] = function(lvl) return '[fg]position [yellow]4[fg] has [yellow]+60%[fg] damage' end,
    ['shoot_5'] = function(lvl) return '[fg]position [yellow]5[fg] shoots [yellow]5[fg] projectiles per second' end,
    ...
    ['lasting_7'] = function(lvl) return '[fg]position [yellow]7[fg] will stay alive for [yellow]20[fg] seconds after dying' end,
    ['defensive_stance'] = function(lvl) return '[fg]first and last positions have ' .. ts(lvl, '+20%', '40%', '60%') .. ' defense' end,
    ['offensive_stance'] = function(lvl) return '[fg]first and last positions have ' .. ts(lvl, '+20%', '40%', '60%') .. ' damage' end,
    ...
    ['last_stand'] = function(lvl) return '[fg]the last unit alive is fully healed and receives a [yellow]+25%[fg] bonus to all stats' end,
    ['seeping'] = function(lvl) return '[fg]enemies taking DoT damage have ' .. ts(lvl, '-20%', '35%', '50%') .. ' defense' end,
    ['deceleration'] = function(lvl) return '[fg]enemies taking DoT damage have ' .. ts(lvl, '-20%', '35%', '50%') .. ' movement speed' end,
    ['annihilation'] = function(lvl) return '[fg]when a voider dies deal its DoT damage to all enemies for [yellow]10[fg] seconds' end,
    ['malediction'] = function(lvl) return ts(lvl, '+1', '3', '5') .. ' max curse targets to all allied cursers' end,
    ['hextouch'] = function(lvl) return '[fg]enemies take ' .. ts(lvl, '10%', '20%', '30%') .. 'of their health damage per second for [yellow]2[fg] seconds when cursed' end,
    ['whispers_of_doom'] = function(lvl) return '[fg]curses apply doom, deal ' .. ts(lvl, '20%', '35%', '50%') .. ' every ' .. ts(lvl, '4', '3', '2') .. ' doom instances' end,
    ...
    ['baneling_burst'] = function(lvl) return '[fg]critters die immediately on contact but also deal ' .. ts(lvl, '2X%', '3X%', '4X%') .. ' AoE damage' end,
    ['blunt_arrow'] = function(lvl) return '[fg]ranger arrows have ' .. ts(lvl, '+15%', '30%', '45%') .. ' chance to knockback' end,
    ['explosive_arrow'] = function(lvl) return '[fg]ranger arrows have ' .. ts(lvl, '+10%', '20%', '30%') .. ' chance to deal ' .. ts(lvl, '10%', '20%', '30%') .. ' AoE damage' end,
    ['divine_machine_arrow'] = function(lvl) return '[fg]ranger arrows have a ' .. ts(lvl, '15%', '25%', '35%') .. ' chance to seek and pierce ' .. ts(lvl, '1', '2', '3') .. ' times' end,
    ['chronomancy'] = function(lvl) return '[fg]mages cast their spells ' .. ts(lvl, '25%', '35%', '45%') .. ' faster' end,
    ...
    ['divine_punishment'] = function(lvl) return '[fg]deal [yellow]6X%[fg] of enemy health as damage to all enemies, X being how many mages you have' end,
    ['assassination'] = function(lvl) return '[fg]crits from rogues deal ' .. ts(lvl, '8x', '10x', '12x') .. ' damage but normal attacks deal [yellow]two-thirds[fg] damage' end,
    ['flying_daggers'] = function(lvl) return '[fg]all projectiles thrown by rogues chain ' .. ts(lvl, '+1', '2', '3') .. ' times' end,
    ['ultimatum'] = function(lvl) return '[fg]projectiles that chain gain ' .. ts(lvl, '+15%', '30%', '45%') .. ' damage with each chain' end,
    ...
    ['unleash'] = function(lvl) return '[fg]all units gain [yellow]+1%[fg] area size and damage every second' end,
    ['reinforce'] = function(lvl) return ts(lvl, '+8%', '16%', '24%') .. ' global damage, defense and aspd if you have one or more enchanters' end,
    ['payback'] = function(lvl) return ts(lvl, '+5%', '10%', '15%') .. ' damage to all allies whenever an enchanter is hit' end,
    ['enchanted'] = function(lvl) return ts(lvl, '+33%', '66%', '99%') .. ' attack speed to a random unit if you have two or more enchanters' end,
    ['freezing_field'] = function(lvl) return '[fg]creates an area that slows enemies by [yellow]75%[fg] for [yellow]4[fg] seconds on sorcerer spell repeat' end,
    ['burning_field'] = function(lvl) return '[fg]creates an area that deals [yellow]90[fg] dps for [yellow]4[fg] seconds on sorcerer spell repeat' end,
    ['gravity_field'] = function(lvl) return '[fg]creates an area that pulls enemies for [yellow]3[fg] and releases them at high speeds on sorcerer spell repeat' end,
    ['magnetism'] = function(lvl) return '[fg]gold coins and healing orbs are attracted to the snake from a longer range' end,
    ['insurance'] = function(lvl) return "[fg]heroes have [yellow]6[fg] times the chance of mercenary's bonus to drop [yellow]4[fg] gold on death" end,
    ['dividends'] = function(lvl) return '[fg]mercenaries deal [yellow]+X%[fg] damage, where X is how much gold you have with a max of 1000%' end,
    ['berserking'] = function(lvl) return '[fg]all warriors have up to ' .. ts(lvl, '200%', '300%', '400%') .. ' attack speed based on missing HP' end,
    ...
    ['blessing'] = function(lvl) return ts(lvl, '+15%', '25%', '35%') .. ' healing effectiveness' end,
    ['haste'] = function(lvl) return '[yellow]+50%[fg] movement speed that decays over [yellow]4[fg] seconds on healing orb pick up' end,
    ['divine_barrage'] = function(lvl) return ts(lvl, '30%', '60%', '90%') .. ' chance to release a ricocheting barrage on healing orb pick up' end,
    ['orbitism'] = function(lvl) return ts(lvl, '+33%', '66%', '99%') .. ' psyker orb movement speed' end,
    ['psyker_orbs'] = function(lvl) return ts(lvl, '+1', '3', '5') .. ' psyker orbs' end,
    ['psychosense'] = function(lvl) return ts(lvl, '+33%', '66%', '99%') .. ' orb range' end,
    ['psychosink'] = function(lvl) return '[fg]psyker orbs deal ' .. ts(lvl, '+50%', '100%', '150%') .. ' damage' end,
    ['rearm'] = function(lvl) return '[fg]constructs repeat their attacks once' end,
    ['taunt'] = function(lvl) return ts(lvl, '15%', '30%', '45%') .. ' chance for constructs to taunt nearby enemies on attack' end,
    ['construct_instability'] = function(lvl) return '[fg]constructs explode when disappearing, dealing ' .. ts(lvl, '200', '300', '400%') .. ' damage' end,
    ...
    ['temporal_chains'] = function(lvl) return '[fg]enemies are ' .. ts(lvl, '15', '25', '35%').. ' slower' end,
    ...
    ['critical_strike'] = function(lvl) return ts(lvl, '8', '16', '24%') .. ' chance for attacks to critically strike, dealing [yellow]2x[fg] damage' end,
    ['noxious_strike'] = function(lvl) return ts(lvl, '8', '16', '24%') .. ' chance for attacks to poison, dealing [yellow]25%[fg] dps for [yellow]4[fg] seconds' end,
    ['infesting_strike'] = function(lvl) return ts(lvl, '8', '16', '24%') .. ' chance for attacks to spawn [yellow]2[fg] critters on kill' end,
    ['kinetic_strike'] = function(lvl) return ts(lvl, '20', '40', '60%') .. ' chance for attacks to push enemies away with high force' end,
    ['burning_strike'] = function(lvl) return 'Attacks burn, dealing [yellow]20%[fg] dps for [yellow]2[fg] seconds' end,
    ['lucky_strike'] = function(lvl) return '[yellow]10%[fg] chance for attacks to cause enemies to drop gold on death' end,
    ...
    ['culling_strike'] = function(lvl) return '[fg]instantly kill elites below ' .. ts(lvl, '20', '35', '50%') .. ' max HP' end,
    ...
    ['psycholeak'] = function(lvl) return '[fg]position [yellow]1[fg] generates [yellow]1[fg] psyker orb every [yellow]8[fg] seconds' end,
	...
	['ritual'] = function(lvl) return  'all cultists gain [yellow]+1%[fg] damage for each attack' end,
    ['sacrifice'] = function(lvl) return '[fg]whenever an unit dies, all cultists regain ' .. ts(lvl, '+25', '+50', '+75%') .. ' of their health' end,
  }
  ...
  trigger:tween(0.25, _G, {slow_amount = 0}, math.linear, function()
      ...
      self.restart_button = Button{group = self.ui, x = gw/2, y = gh - 200, force_update = true, button_text = 'restart run (r)', fg_color = 'bg10', bg_color = 'bg', action = function(b)
        ...
        TransitionEffect{group = main.transitions, x = gw/2, y = gh/2, color = state.dark_transitions and bg[-2] or fg[0], transition_action = function()
          ...
          run_passive_pool = {
            ...
            'insurance', 'dividends', 'berserking', 'unwavering_stance', 'unrelenting_stance', 'blessing', 'haste', 'divine_barrage', 'orbitism', 'psyker_orbs', 'psychosink', 'rearm', 'taunt', 'construct_instability',
            'intimidation', 'vulnerability', 'temporal_chains', 'ceremonial_dagger', 'homing_barrage', 'critical_strike', 'noxious_strike', 'infesting_strike', 'burning_strike', 'lucky_strike', 'healing_strike', 'stunning_strike',
            'silencing_strike', 'culling_strike', 'lightning_strike', 'psycholeak', 'divine_blessing', 'hardening', 'kinetic_strike', 'critboost', 'ritual'
          }
          max_units = math.clamp(7 + current_new_game_plus, 7, 12)
          main:add(BuyScreen'buy_screen')
          locked_state = nil
    ...
    if self:is(MainMenu) then
      self.ng_plus_minus_button = Button{group = self.ui, x = gw/2 - 58, y = gh - 50, force_update = true, button_text = 'NG+ down', fg_color = 'bg10', bg_color = 'bg', action = function(b)
        ...
        b.spring:pull(0.2, 200, 10)
        b.selected = true
        current_new_game_plus = math.clamp(current_new_game_plus - 1, 0, 10)
