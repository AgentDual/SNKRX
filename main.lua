...
function init()
  ...
  character_effect_descriptions_gray = {
    ...
    ['flagellant'] = function() return '[light_bg]4X flagellant max HP and grants +12% damage to all allies per cast instead' end,
    ...
    ['silencer'] = function() return '[light_bg]the curse stuns enemies, deals ' .. get_character_stat('silencer', 3, 'dmg') .. ' damage and curses 3 more enemies' end,
